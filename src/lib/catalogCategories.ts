...
export const catalogCategories: CatalogCategory[] = [
  {
    ...
    gallery: [
      { src: C + 'ya-wheels-studio.jpg', caption: 'Шлифовальные круги GD-Abrasives' },
      { src: C + 'ya-wheels-blue.jpg', caption: 'Круги на керамической связке' },
      { src: C + 'ya-wheels-blue-2.jpg', caption: 'Круги разных диаметров и спецификаций' },
      { src: C + 'ya-wheels-color.jpg', caption: 'Круги и шлифовальные головки' },
      { src: C + 'ya-spread.jpg', caption: 'Ассортимент кругов' },
      { src: C + 'ya-spring-1.jpg', caption: 'Круг с перфорацией для шлифовки торцев пружин' },
      ...
      { src: C + 'ya-qc-1.jpg', caption: 'Контроль геометрии круга при приёмке' },
      { src: C + 'ya-shop-1.jpg', caption: 'Готовая продукция на производстве' },
      { src: C + 'ya-showroom.jpg', caption: 'Экспозиция продукции' },
    ],
  },
  {
    slug: 'cutoff-large',
    ...
    gallery: [
      { src: C + 'ya-ldco-1600.jpg', caption: 'LDCO 1600×15×230, 5NZ20SBF-COLD, 100 м/с' },
      { src: C + 'ya-ldco-1270.jpg', caption: 'LDCO 1270×13,5×127, 100 м/с' },
      { src: C + 'ya-ldco-1200.jpg', caption: 'LDCO 1200 мм' },
      { src: C + 'ya-ldco-crate.jpg', caption: 'Отгрузка кругов LDCO в деревянной обрешётке' },
  ...
  },
  {
    ...
    gallery: [
      { src: C + 'ya-cbn-1.jpg', caption: 'Эльборовый (CBN) круг' },
      { src: C + 'ya-cbn-2.jpg', caption: 'Эльборовый круг, обратная сторона' },
      { src: C + 'ya-cbn-3.jpg', caption: 'CBN круг в оснастке' },
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: C + 'ya-discs-color.jpg', caption: 'Отрезные и зачистные круги — со склада' },
      { src: C + 'ya-discs-color-2.jpg', caption: 'Ассортимент кругов на складе' },
  ...
  },
  {
    ...
    gallery: [
      { src: C + 'ya-rolls-paper.jpg', caption: 'Шкурка в рулонах' },
      { src: C + 'ya-rolls-3.jpg', caption: 'Рулоны шлифовальной шкурки разной зернистости' },
      { src: C + 'ya-belts-1.jpg', caption: 'Шлифовальные ленты' },
      { src: C + 'ya-belts-2.jpg', caption: 'Ленты бесконечные, склейка' },
      { src: C + 'ya-belts-3.jpg', caption: 'Ленты с керамическим зерном' },
  ...
  },
  {
    ...
    gallery: [
      { src: C + 'ya-lab-set.jpg', caption: 'Расходники для металлографической лаборатории' },
  ...
  },
  {
    ...
    gallery: [
      { src: C + 'ya-cutter-1.jpg', caption: 'Дисковая фреза по металлу' },
      { src: C + 'ya-cutter-2.jpg', caption: 'Дисковая фреза, вид сверху' },
      { src: C + 'ya-cutter-3.jpg', caption: 'Дисковая фреза с твердосплавными зубьями' },
      { src: C + 'ya-cutter-4.jpg', caption: 'Фреза со сменными пластинами' },
    ],
  },
  {
    slug: 'circular-saws',
    ...
    gallery: [
      { src: C + 'ya-saw-1.jpg', caption: 'Циркулярная пила по металлу' },
      { src: C + 'ya-saw-2.jpg', caption: 'Пильный диск с твердосплавными напайками' },
      { src: C + 'ya-saw-3.jpg', caption: 'Пила 300 мм, 45 зубьев' },
  ...
  },
  {
    ...
    gallery: [
      { src: C + 'ya-roll-steel-1.jpg', caption: 'Кованый прокатный валок после шлифовки' },
      { src: C + 'ya-roll-steel-2.jpg', caption: 'Валки на участке механообработки' },
      { src: C + 'ya-roll-steel-3.jpg', caption: 'Валки в цехе' },
      { src: '/images/roll-photo-2.jpg', caption: 'Кованый прокатный валок' },
      { src: C + 'ya-rg-wheel.jpg', caption: 'Круг для шлифовки прокатных валков' },
      { src: C + 'ya-rg-wheel-2.jpg', caption: 'Круг для шлифовки валков, крупно' },

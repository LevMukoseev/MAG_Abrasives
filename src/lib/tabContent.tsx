  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <p className="text-ink/70">Детальное описание для шлифовки торцев пружин скоро появится здесь.</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        ...
        <p className="text-ink/70">Детальное описание для зубошлифования скоро появится здесь.</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        ...
        <p className="text-ink/70">Детальное описание для бесцентрового шлифования скоро появится здесь.</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        ...
        <p className="text-ink/70">Детальное описание для круглого шлифования скоро появится здесь.</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        ...
        <p className="text-ink/70">Детальное описание для плоского шлифования скоро появится здесь.</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        ...
        <p className="text-ink/70">Детальное описание для зачистных кругов скоро появится здесь.</p>
      </div>
    ),
  },
];
